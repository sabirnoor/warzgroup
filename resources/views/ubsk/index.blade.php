    ...
    <div class="container">
        ...
        <!-- Loading Screen -->
                        <div data-u="loading" class="jssorl-004-double-tail-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
                            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="public/assets/img/double-tail-spin.svg" />
                        </div>
                        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
                            <div style="background-color:#000000;">
                                <img data-u="image" style="opacity:0.5;" src="public/assets/img/px-action-athlete-athletes-848618-image.jpg" />
                            ...
                            <div>
                                <img data-u="image" src="public/assets/img/px-beach-daylight-fun-1430675-image.jpg" />
                            ...
                            <div>
                                <img data-u="image" src="public/assets/img/px-fun-man-person-2361598-image.jpg" />
                                <div data-ts="flat" data-p="2720" data-po="50% 48%" style="left:0px;top:0px;width:980px;height:380px;position:absolute;">
                            ...
                            <div style="background-color:#000000;">
                                <img data-u="image" style="opacity:0.5;" src="public/assets/img/faded-monaco-scenery-evening-dark-picjumbo-com-image.jpg" />
                            ...
                            <div>
                                <img data-u="image" src="public/assets/img/px-bloom-blossom-flora-65219-image.jpg" />
