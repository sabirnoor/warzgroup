        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{url('/')}}"> <img src="{{url('public/assets/img/logo-ubsk.jpeg')}}" height="120" alt="logo"> </a>
                    <h2 style="color:#fff;font-size:40px;">उज्ज्वल भविष्य शिछण केंद्र</h2>
                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-end"
                        ...
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('about')}}">Registration</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/')}}">Result</a>
                            </li>
